...
public class Ethiopis_News  extends Activity {
    ...
    Ethiopis_News_Adapter reading_adapter;
    List<ethiopis_news_data> list;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ethiopis__news);
        ...
        list = new ArrayList<>();
        reading_adapter = new Ethiopis_News_Adapter(getApplicationContext(),list);
        list_container = (RecyclerView) findViewById(R.id.News_RecycleView);
       ...
       // getadvert();
        ...
        firestore.collection("News").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(QuerySnapshot queryDocumentSnapshots, FirebaseFirestoreException e) {
                ...
                for (DocumentChange doc: queryDocumentSnapshots.getDocumentChanges() )
                {
                    ...
                    {
                        ethiopis_news_data read= doc.getDocument().toObject(ethiopis_news_data.class);
                        list.add(read);
